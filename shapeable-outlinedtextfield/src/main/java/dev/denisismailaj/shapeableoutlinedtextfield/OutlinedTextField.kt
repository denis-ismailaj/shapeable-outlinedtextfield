package dev.denisismailaj.shapeableoutlinedtextfield
 ...
 * @param enabled controls the enabled state of the [ShapeableOutlinedTextField]. When `false`, the text field will
 * be neither editable nor focusable, the input of the text field will not be selectable,
 * visually text field will appear in the disabled UI state
 * @param readOnly controls the editable state of the [ShapeableOutlinedTextField]. When `true`, the text
 ...
 */
@Composable
fun ShapeableOutlinedTextField(
    value: String,
    ...
    cornerRadius: Dp = OutlinedTextFieldCornerRadius
) {
...
/**
 * Calculate the width of the [ShapeableOutlinedTextField] given all elements that should be
 * placed inside
 */
...
/**
 * Calculate the height of the [ShapeableOutlinedTextField] given all elements that should be
 * placed inside
 */
 ...
 * the [ShapeableOutlinedTextField]
 */
...
/**
 * A draw modifier to draw a border line in [ShapeableOutlinedTextField]
 */
